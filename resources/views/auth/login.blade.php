        ...
        <div class="bg-white rounded-2xl shadow-[0_4px_16px_rgba(0,0,0,.08)] border border-gray-100 p-6 sm:p-8">
            ...
            <div class="space-y-3">
                <form action="{{ route('login.post') }}" method="POST">
                    ...
                    <button type="submit" class="w-full flex items-center justify-center gap-3 border border-gray-200 hover:border-gray-300 hover:bg-gray-50 text-sm font-semibold px-4 py-3 rounded-xl transition-colors shadow-sm">
                ...
                <form action="{{ route('login.post') }}" method="POST">
                    @csrf
                    <input type="hidden" name="proveedor" value="microsoft">
                    <button type="submit" class="w-full flex items-center justify-center gap-3 border border-gray-200 hover:border-gray-300 hover:bg-gray-50 text-sm font-semibold px-4 py-3 rounded-xl transition-colors shadow-sm">
