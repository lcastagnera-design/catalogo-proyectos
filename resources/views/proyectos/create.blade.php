...
@section('content')
    ...
    <div class="bg-white rounded-2xl shadow-[0_4px_16px_rgba(0,0,0,.08)] border border-gray-100 p-6 sm:p-8 max-w-4xl">
        ...
        <form action="{{ route('proyectos.store') }}" method="POST" class="space-y-5">
            @csrf
            @include('proyectos.partials._form')
            ...
            <div class="flex items-center gap-3 pt-4 border-t border-gray-100">
                ...
                <a href="{{ route('proyectos.index') }}" class="text-sm font-medium text-gray-500 hover:text-gray-700 px-4 py-2.5">Cancelar</a>
            </div>
        </form>
    </div>
@endsection
